...
public class EmailIsUniqueValidation implements ConstraintValidator<EmailIsUnique, Object> {
    ...
    @Override
    public void initialize(EmailIsUnique constraintAnotations){
        ConstraintValidator.super.initialize(constraintAnotations);
        this.entity = constraintAnotations.entity();
        this.field = constraintAnotations.field();
        this.message = constraintAnotations.message();
    }
